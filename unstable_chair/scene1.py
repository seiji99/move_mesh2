...
shape_id, style_id, shape_label, scene = chair_dataset[1]

# 移動させたいメッシュの名前リスト，椅子上部に該当
mesh_names_to_move = ["Mesh", "Mesh.001", "Mesh.011", "Mesh.012", "Mesh.013", "Mesh.014"]

randx = random.randint(-20, 20)
randy = random.randint(-20, 20)
randz = random.randint(-20, 20)

# 移動ベクトル
translation_vector = [randx, randy, randz]

camera_positions = {"position": [0, 1, 1.5], "target_direction": [0, -0.5, -1], "output_filename": "scene1.png"}
