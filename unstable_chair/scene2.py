...
shape_id, style_id, shape_label, scene = chair_dataset[2]

# 移動させたいメッシュの名前リスト，椅子上部に該当
mesh_names_to_move = ["Mesh", "Mesh.001", "Mesh.002"]
...
camera_positions = {"position": [0, 1, 1.5], "target_direction": [0, -0.5, -1], "output_filename": "scene2.png"}
